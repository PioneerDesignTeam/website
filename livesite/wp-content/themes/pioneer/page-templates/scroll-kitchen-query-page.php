<?php
/**
 * Template Name: Scroll Kitchen query
 */
...
<?php 
  ...
  $leng = str_replace('\\','',$_REQUEST['count']);
...
<?php if ($query->have_posts()) :  ?>   
  <?php $published_posts = 0; while ($query->have_posts()) : $query->the_post(); ?>
  <?php $published_posts++; endwhile; ?>
<?php endif;  ?>
...
<?php if ($query->have_posts()) :  ?>
	...
	<?php $flag = 1; while ( $query->have_posts()) : $query->the_post(); ?>
    <?php if($flag > $leng and ($published_posts != $leng)){?>
      <li>
        <figure>
