...
<?php
/**
 * Template Name:  Bath list Template
 */
		...
		<div class="category-nav">
			<ul>
                ...
                $class = "";
							...
							echo '<li class="mob-view name hover '.$class.'"><a href="'.esc_url( home_url( '/' ) ).'bath_category/'.$catslug.'" class="link">'.$catname.'</a></li>';
...
<!-- BEGIN MAIN SECTION -->
	<div id="main" >
		<div class="catalog kitchen">
			...
			<div class="content">
				<div class="category-holder"><div class="cat-slug" style="display: none;"><?php echo $term->slug; ?></div>
