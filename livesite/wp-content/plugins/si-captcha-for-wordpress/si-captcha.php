...
echo '
<div class="captcha-holder">
<span style="display:block; color: #71747a; font-size: 15px; margin-bottom: 10px;">Captcha:</span>  
';
echo '<p>';
...
$label_string .= '</label>';
$required_string = '<span class="required">'.$si_captcha_opt['si_captcha_required_indicator']."</span>\n";
$input_string = '<input id="captcha_code" name="captcha_code" class="rfield" type="text" size="6" ' . $si_aria_required . ' />
';
...
echo ' <span class="error">Required field</span> </p>
<div ';
echo ($si_captcha_opt['si_captcha_captcha_small'] == 'true') ? 'class="captchaSizeDivSmall"' : 'class="captchaSizeDivLarge"';
echo '>';
$this->si_captcha_captcha_html('si_image_com','com');
