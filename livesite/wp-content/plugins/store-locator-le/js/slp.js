    ...
    Map: function(aMapCanvas) {
        ...
        this.putMarkers = function(markerListNatural, animation) {
            ...
            if (markerCount === 0) {
              ...
              var divs = jQuery("#map_sidebar .results_wrapper");
              var k = 0;
  for(var i = 0; i < divs.length; i+=2) {
    if(k == 0){
        divs.slice(i, i+2).wrapAll("<div class='row-result first'></div>");
    } else {
        divs.slice(i, i+2).wrapAll("<div class='row-result'></div>");
    }
