...
<a href="http://maps.google.com/maps/place/[slp_location address]" target="_blank">Directions</a>
</span>
...
[slp_location image         wrap    img]</span>
    ...
    <div class="results_row_right_column"  id="slp_right_cell_[slp_location id]"  >
        ...
        <span class="slp_result_contact slp_result_directions"><a href="http://[slp_location map_domain]/maps/place/[slp_location location_address]" target="_blank" class="storelocatorlink">[slp_location directions_text]</a></span>
        ...
        ,
        // If you change this change default.css theme as well. <span class="slp_result_contact slp_result_directions"><a href="http://[slp_location map_domain]/maps?saddr=[slp_location search_address]&daddr=[slp_location location_address]" target="_blank" class="storelocatorlink">[slp_location directions_text]</a></span>
        'searchlayout' =>
